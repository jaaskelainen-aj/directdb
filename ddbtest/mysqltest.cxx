...
const char* g_create_table = "CREATE TABLE ddb_demo ("
                             ...
                             ",PRIMARY KEY(id)"
                             ") ENGINE=InnoDB";
const char* g_create_index = "CREATE UNIQUE INDEX demo_ndx ON ddb_demo(id)";
...
main(int argc, char** argv)
{
    ...
    for (i = 0; i < 20; i++) {
        query << "INSERT INTO ddb_demo(ts, data, tf) values(CURRENT_TIMESTAMP(), 'Test item "
              << i + 1 << "', ";
        query << (int)((i % 2) ? 1 : 0) << ")";
